...
exports.ContractVerifierUI = {
    ...
    _setCode({ name, content }, codeWrapperEl, filesListEl, fileEl) {
        ...
        filesListEl
            ?.querySelector(`.${exports.classNames.FILE}.active`)
    ...
    loadSourcesData(sourcesData, opts) {
        ...
        this._setCode(sourcesData.files[0], document.querySelector(opts.contentSelector), document.querySelector(opts.fileListSelector), document.querySelector(`${opts.fileListSelector} .contract-verifier-file`));
    },
};
