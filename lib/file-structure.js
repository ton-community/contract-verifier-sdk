...
const TreeFile = ({ name }, theme) => {
    return (0, dom_1.div)({ className: `${contract_verifier_ui_1.classNames.FILE} ${contract_verifier_ui_1.classNames.TREE_ITEM}` }, (0, dom_1.img)({
...
const TreeFolder = (props, theme, ...children) => {
    ...
    return (0, dom_1.div)({ className: contract_verifier_ui_1.classNames.FOLDER_CONTAINER }, (0, dom_1.div)({
        onClick: changeOpened.bind(this, theme),
        className: `folder-header ${contract_verifier_ui_1.classNames.FOLDER} ${contract_verifier_ui_1.classNames.TREE_ITEM}`,
        opened: opened,
    }, (0, dom_1.img)({
