...
export const TreeFile = ({ name }, theme) => {
    return div({ className: `${classNames.FILE} ${classNames.TREE_ITEM}` }, img({
...
export const TreeFolder = (props, theme, ...children) => {
    ...
    return div({ className: classNames.FOLDER_CONTAINER }, div({
    ...
    }), div(null, folderName)), div({ className: `${opened ? "" : "hide"} folder-content` }, ...children));
};
